...
def convert_qudt_to_grouped_json():
    ...
    print(f"Saved {len(result['allUnits'])} units in {len(result['quantityKinds'])} categories to units.ucum.json")
